...
final class AppCoordinator: Coordinator {
    ...
    private func showOnboardingFlow() {
        let onBoardingCoordinator = OnBoardingCoordinator(navigationController: UINavigationController()) // 온보딩 전용 Navigation
    ...
    private func showAuthFlow() {
        let authCoordinator = AuthCoordinator(navigationController: UINavigationController()) // 로그인/회원가입 전용 Navigation
    ...
    private func showTabBarFlow() {
        let tabBarCoordinator = TabBarCoordinator(tabBarController: UITabBarController()) // 메인 탭바
