...
final class MyPageCollectionView: UICollectionView {
    ...
    override init(frame: CGRect, collectionViewLayout layout: UICollectionViewLayout) {
        ...
        setLayout()
        self.register(MyPageCollectionViewCell.self,
...
extension MyPageCollectionView: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: MyPageCollectionViewCell.identifier,
                                                            for: indexPath) as? MyPageCollectionViewCell
        else {
            return UICollectionViewCell()
        }
        cell.configure(model: MyPageCollectionViewModel.model[indexPath.section].cellModel[indexPath.row])
