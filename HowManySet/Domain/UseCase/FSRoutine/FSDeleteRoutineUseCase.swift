...
/// Firestore 기반 운동 루틴을 삭제하는 유스케이스 구현체입니다.
/// FSRoutineRepository를 통해 특정 사용자의 운동 루틴을 삭제하는 기능을 제공합니다.
final class FSDeleteRoutineUseCase: DeleteRoutineUseCaseProtocol {
    ...
    /// 주어진 사용자 ID에 해당하는 운동 루틴을 Firestore에서 삭제합니다.
    /// - Parameters:
