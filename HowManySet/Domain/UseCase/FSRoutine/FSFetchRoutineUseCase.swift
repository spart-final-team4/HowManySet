...
/// Firestore 기반 운동 루틴을 조회하는 유스케이스 구현체입니다.
/// FSRoutineRepository를 통해 특정 사용자의 운동 루틴 목록을 비동기적으로 가져오는 기능을 제공합니다.
final class FSFetchRoutineUseCase: FetchRoutineUseCaseProtocol {
    ...
    /// 주어진 사용자 ID에 해당하는 운동 루틴 리스트를 Firestore에서 비동기적으로 조회합니다.
