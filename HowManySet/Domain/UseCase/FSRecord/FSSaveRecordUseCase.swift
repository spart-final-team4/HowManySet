...
/// Firestore 기반 운동 기록을 저장하는 유스케이스 구현체입니다.
/// FSRecordRepository를 통해 클라우드 저장 로직을 실행합니다.
final class FSSaveRecordUseCase: SaveRecordUseCaseProtocol {
    ...
    /// 주어진 사용자 ID에 해당하는 운동 기록을 Firestore에 저장합니다.
    /// - Parameters:
